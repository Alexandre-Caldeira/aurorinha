...
if i >= 10 && length(drone.pCom.cStatus)<32
    ...
    fprintf(drone.pCom.controlChannel, ...
        sprintf( 'AT*%s=%i,%s\r', 'CONFIG', drone.pCom.SequenceNumber, '"control:altitude_max","3000"'));
    drone.pCom.SequenceNumber = drone.pCom.SequenceNumber + 1;
    
    % Set maximum flight_without_shell 
    fprintf(drone.pCom.controlChannel, ...
        sprintf( 'AT*%s=%i,%s\r', 'CONFIG', drone.pCom.SequenceNumber, '"control:flight_without_shell","TRUE"'));
    drone.pCom.SequenceNumber = drone.pCom.SequenceNumber + 1;
